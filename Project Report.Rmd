...
# Limitations
Limitations 
One limitation of our analysis was that the flu and COVID-19 vaccination data did not overlap since we did not have zip code level data for both datasets. Rather, we decided to move forward with separate analyses for flu and COVID-19 data because we believed that this would still be a valuable analysis to understand patterns of flu and COVID-19 vaccine location data. 
